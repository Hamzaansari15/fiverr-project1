...
const RightImageSection: React.FC<LeftImageSectionProps> = ({
  isHeading,
  heading,
  list,
  isFirstText,
  ...
  return (
    <section className="flex justify-center px-4 md:px-12 py-12">
      <div className="w-full max-w-[1280px] md:grid grid-cols-12 flex flex-col-reverse items-center gap-8">
        <div className="col-span-12 md:col-span-6 w-full flex justify-center md:justify-start">
        ...
        <div className="w-full max-w-[360px] sm:max-w-[480px] col-span-12 md:col-span-6 flex flex-col">
          ...
          <ul className="list-disc list-outside ml-4 mt-4 space-y-1 text-gray-[#3C3B3B] text-sm">
            {list?.map((item, index) => (
